  ...
  render() {
    return (
      ...
      <View style={{backgroundColor:'white',flexDirection:'row',}}>
        <View style={{flex:.1,}}>
          <TextInput placeholder='Email Id' value={this.state.signinText}></TextInput>
        </View>
        <View style={{flex:.1,}}>
          <TextInput placeholder='Password'></TextInput>
        </View>
      </View>
        <TextInput placeholder='@ Domain'></TextInput>
...
class Register extends Component {
  ...
  render() {
    return (
      ...
      <View>
        <TextInput placeholder='Email Id' keyboardType='email-address' maxLength={100} ></TextInput>
      </View>
      <View>
        <TextInput placeholder='Mobile number' keyboardType='phone-pad' maxLength={20}></TextInput>
      </View>
